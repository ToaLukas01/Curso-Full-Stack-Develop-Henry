...
async function problemA () {
  ...
  // AsyncAwait version
  const poemaA = await promisifiedReadFile('poem-one/stanza-01.txt')
  blue(poemaA)
}
...
async function problemB () {
  ...
  // AsyncAwait version
  const poema2 = await promisifiedReadFile('poem-one/stanza-02.txt')
  const poema3 = await promisifiedReadFile('poem-one/stanza-03.txt')
  blue(poema3)
  blue(poema2)
}
...
async function problemD () {
  ...
  // AsyncAwait version
  try {
    const poema4 = await promisifiedReadFile('poem-one/wrong-file-name.txt')
    blue(poema4)
  } catch (err){
    magenta(err);
  }
...
async function problemE () {
  ...
  try {
    const poema3 = await promisifiedReadFile('poem-one/stanza-03.txt')
    const poema4 = await promisifiedReadFile('poem-one/stanza-04.txt')
    blue(poema3)
    blue(poema4)
  } catch (err){
    magenta(err);
